...
class Solver {
  solvePuzzlePattern(startSequence) {
    ...
    moves = this.solvePuzzleFringe(curArrayState, [
      1,
      2,
      "x",
      "x",
    ...
    moves = this.solvePuzzleFringe(aArr, [
      1,
      2,
      3,
      4,
    ...
    moves = this.solvePuzzleFringe(bArr, [
      1,
      2,
      3,
      4,
    ...
    moves = this.solvePuzzleFringe(cArr, [
      1,
      2,
      3,
      4,
  ...
  solvePuzzleFringe(startSequence, pattern) {
    ...
    if (pattern) {
      ...
      while (i < pattern.length - 1) {
        if (pattern[i] === "x")
          startSequence[startSequence.indexOf(i + 1)] = "x";
        if (pattern[i] === "o")
          startSequence[startSequence.indexOf(i + 1)] = "o";
        i++;
      }
    }
